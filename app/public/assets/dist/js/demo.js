...
$('a[href="'+url+'"]').closest('.treeview').addClass('active');
$('a[href="'+url+'"]').parent('li').addClass('active');
$('a[href="'+url+'"]').parent('ul').addClass('menu-open');
$('a[href="'+url+'"]').parent('ul').css('display','block');
...
$(function(){
  ...
  $('.panel-heading').on('click', '.btn-filter', function(e) {
    var $this = $(this),
    $panel = $this.parents('.panel-heading'),
        ...
        $panel.find('.panel-filter').slideToggle(function() {
            if ($panelFilter.is(':visible')) { 
                $('.panel-heading .btn-filter').addClass('active');
                  displayFilterPanel = 'true';
            } else {
               displayFilterPanel = 'false';
                $('.panel-heading .btn-filter').removeClass('active');
            }
             Cookies.set('ti_displayFilterPanel', displayFilterPanel);
        });
  });
console.log(displayFilterPanel);
